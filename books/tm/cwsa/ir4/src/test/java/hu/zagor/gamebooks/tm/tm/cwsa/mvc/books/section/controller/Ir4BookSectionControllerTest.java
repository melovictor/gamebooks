...
/**
 * Unit test for class {@link Ir4BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ir4BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ir4BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ir4BookSectionController(sectionHandler).getClass();
        // THEN
    }
