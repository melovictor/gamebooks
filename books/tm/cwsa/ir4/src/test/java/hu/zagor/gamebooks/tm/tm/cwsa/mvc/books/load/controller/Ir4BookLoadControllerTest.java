...
/**
 * Unit test for class {@link Ir4BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ir4BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ir4BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ir4BookLoadController(sectionHandler).getClass();
        // THEN
    }
