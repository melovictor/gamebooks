...
public class Tm5BookLoadController extends TmBookLoadController {
     ...
     */
    @Autowired
    public Tm5BookLoadController(@Qualifier("tmSectionHandlingService") final SectionHandlingService sectionHandlingService) {
