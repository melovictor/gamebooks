...
/**
 * Unit test for class {@link Tm5BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Tm5BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Tm5BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Tm5BookLoadController(sectionHandler).getClass();
        // THEN
    }
