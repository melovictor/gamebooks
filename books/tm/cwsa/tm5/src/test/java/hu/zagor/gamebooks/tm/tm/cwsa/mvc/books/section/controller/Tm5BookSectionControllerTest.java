...
/**
 * Unit test for class {@link Tm5BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Tm5BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Tm5BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Tm5BookSectionController(sectionHandler).getClass();
        // THEN
    }
