...
/**
 * Unit test for class {@link Ir1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ir1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ir1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ir1BookLoadController(sectionHandler).getClass();
        // THEN
    }
