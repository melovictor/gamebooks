...
/**
 * Unit test for class {@link Ir3BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ir3BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ir3BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ir3BookSectionController(sectionHandler).getClass();
        // THEN
    }
