...
/**
 * Unit test for class {@link Tm1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Tm1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Tm1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Tm1BookSectionController(sectionHandler).getClass();
        // THEN
    }
