...
/**
 * Unit test for class {@link Tm3BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Tm3BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Tm3BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Tm3BookLoadController(sectionHandler).getClass();
        // THEN
    }
