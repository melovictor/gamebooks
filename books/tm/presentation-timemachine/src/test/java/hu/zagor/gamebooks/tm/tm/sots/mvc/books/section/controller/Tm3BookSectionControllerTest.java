...
/**
 * Unit test for class {@link Tm3BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Tm3BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Tm3BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Tm3BookSectionController(sectionHandler).getClass();
        // THEN
    }
