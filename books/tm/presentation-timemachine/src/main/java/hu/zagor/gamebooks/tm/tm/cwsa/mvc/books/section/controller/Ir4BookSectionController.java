...
public class Ir4BookSectionController extends Tm5BookSectionController {
     ...
     */
    @Autowired
    public Ir4BookSectionController(@Qualifier("tmSectionHandlingService") final SectionHandlingService sectionHandlingService) {
