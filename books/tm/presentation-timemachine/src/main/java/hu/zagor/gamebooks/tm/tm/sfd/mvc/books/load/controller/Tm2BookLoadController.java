...
public class Tm2BookLoadController extends TmBookLoadController {
     ...
     */
    @Autowired
    public Tm2BookLoadController(@Qualifier("tmSectionHandlingService") final SectionHandlingService sectionHandlingService) {
