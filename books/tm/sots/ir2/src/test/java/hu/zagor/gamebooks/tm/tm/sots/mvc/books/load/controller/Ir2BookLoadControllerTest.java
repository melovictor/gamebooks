...
/**
 * Unit test for class {@link Ir2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ir2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ir2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ir2BookLoadController(sectionHandler).getClass();
        // THEN
    }
