...
/**
 * Unit test for class {@link Ir2BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ir2BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ir2BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ir2BookSectionController(sectionHandler).getClass();
        // THEN
    }
