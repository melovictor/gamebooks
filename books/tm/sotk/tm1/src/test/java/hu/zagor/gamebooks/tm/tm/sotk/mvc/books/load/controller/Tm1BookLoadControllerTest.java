...
/**
 * Unit test for class {@link Tm1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Tm1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Tm1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Tm1BookLoadController(sectionHandler).getClass();
        // THEN
    }
