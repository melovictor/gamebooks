...
/**
 * Unit test for class {@link Ir1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ir1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ir1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ir1BookSectionController(sectionHandler).getClass();
        // THEN
    }
