...
public class Ir3BookSectionController extends Tm2BookSectionController {
     ...
     */
    @Autowired
    public Ir3BookSectionController(@Qualifier("tmSectionHandlingService") final SectionHandlingService sectionHandlingService) {
