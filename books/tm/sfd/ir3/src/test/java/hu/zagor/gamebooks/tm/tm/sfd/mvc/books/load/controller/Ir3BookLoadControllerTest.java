...
/**
 * Unit test for class {@link Ir3BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ir3BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ir3BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ir3BookLoadController(sectionHandler).getClass();
        // THEN
    }
