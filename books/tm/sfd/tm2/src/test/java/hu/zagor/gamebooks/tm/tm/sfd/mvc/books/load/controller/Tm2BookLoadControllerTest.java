...
/**
 * Unit test for class {@link Tm2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Tm2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Tm2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Tm2BookLoadController(sectionHandler).getClass();
        // THEN
    }
