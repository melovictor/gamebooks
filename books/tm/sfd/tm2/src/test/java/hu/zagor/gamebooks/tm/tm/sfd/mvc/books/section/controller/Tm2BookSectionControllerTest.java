...
/**
 * Unit test for class {@link Tm2BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Tm2BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Tm2BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Tm2BookSectionController(sectionHandler).getClass();
        // THEN
    }
