...
/**
 * Unit test for class {@link St2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class St2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new St2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new St2BookLoadController(sectionHandler).getClass();
        // THEN
    }
