...
/**
 * Unit test for class {@link Nyk1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Nyk1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Nyk1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Nyk1BookSectionController(sectionHandler).getClass();
        // THEN
    }
