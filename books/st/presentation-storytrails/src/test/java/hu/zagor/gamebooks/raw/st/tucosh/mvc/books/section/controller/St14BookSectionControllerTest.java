...
/**
 * Unit test for class {@link St14BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class St14BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new St14BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new St14BookSectionController(sectionHandler).getClass();
        // THEN
    }
