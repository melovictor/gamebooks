...
/**
 * Unit test for class {@link Nyk3BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Nyk3BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Nyk3BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Nyk3BookSectionController(sectionHandler).getClass();
        // THEN
    }
