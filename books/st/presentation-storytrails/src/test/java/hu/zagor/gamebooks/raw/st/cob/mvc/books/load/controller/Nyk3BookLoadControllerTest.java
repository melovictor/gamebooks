...
/**
 * Unit test for class {@link Nyk3BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Nyk3BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Nyk3BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Nyk3BookLoadController(sectionHandler).getClass();
        // THEN
    }
