...
/**
 * Unit test for class {@link St3BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class St3BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new St3BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new St3BookLoadController(sectionHandler).getClass();
        // THEN
    }
