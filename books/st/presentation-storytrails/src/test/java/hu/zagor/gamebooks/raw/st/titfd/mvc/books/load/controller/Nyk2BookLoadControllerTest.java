...
/**
 * Unit test for class {@link Nyk2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Nyk2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Nyk2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Nyk2BookLoadController(sectionHandler).getClass();
        // THEN
    }
