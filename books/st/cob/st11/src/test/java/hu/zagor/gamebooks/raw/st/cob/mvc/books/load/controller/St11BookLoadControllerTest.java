...
/**
 * Unit test for class {@link St11BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class St11BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new St11BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new St11BookLoadController(sectionHandler).getClass();
        // THEN
    }
