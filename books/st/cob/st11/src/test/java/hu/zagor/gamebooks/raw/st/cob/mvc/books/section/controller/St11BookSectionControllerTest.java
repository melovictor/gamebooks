...
/**
 * Unit test for class {@link St11BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class St11BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new St11BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new St11BookSectionController(sectionHandler).getClass();
        // THEN
    }
