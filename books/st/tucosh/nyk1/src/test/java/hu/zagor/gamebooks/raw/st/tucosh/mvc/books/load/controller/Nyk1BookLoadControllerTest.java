...
/**
 * Unit test for class {@link Nyk1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Nyk1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Nyk1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Nyk1BookLoadController(sectionHandler).getClass();
        // THEN
    }
