...
/**
 * Unit test for class {@link St2BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class St2BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new St2BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new St2BookSectionController(sectionHandler).getClass();
        // THEN
    }
