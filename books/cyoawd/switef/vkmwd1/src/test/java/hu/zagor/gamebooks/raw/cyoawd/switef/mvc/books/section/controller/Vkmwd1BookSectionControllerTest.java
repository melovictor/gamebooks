...
/**
 * Unit test for class {@link Vkmwd1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Vkmwd1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Vkmwd1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Vkmwd1BookSectionController(sectionHandler).getClass();
        // THEN
    }
