...
/**
 * Unit test for class {@link Vkmwd1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Vkmwd1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Vkmwd1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Vkmwd1BookLoadController(sectionHandler).getClass();
        // THEN
    }
