...
/**
 * Unit test for class {@link Cyoawd1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoawd1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoawd1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoawd1BookLoadController(sectionHandler).getClass();
        // THEN
    }
