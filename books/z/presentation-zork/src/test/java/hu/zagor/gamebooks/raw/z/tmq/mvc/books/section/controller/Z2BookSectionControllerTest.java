...
/**
 * Unit test for class {@link Z2BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Z2BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Z2BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Z2BookSectionController(sectionHandler).getClass();
        // THEN
    }
