...
/**
 * Unit test for class {@link Z3BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Z3BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Z3BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Z3BookLoadController(sectionHandler).getClass();
        // THEN
    }
