...
/**
 * Unit test for class {@link Z1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Z1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Z1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Z1BookLoadController(sectionHandler).getClass();
        // THEN
    }
