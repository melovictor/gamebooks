...
/**
 * Unit test for class {@link Z2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Z2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Z2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Z2BookLoadController(sectionHandler).getClass();
        // THEN
    }
