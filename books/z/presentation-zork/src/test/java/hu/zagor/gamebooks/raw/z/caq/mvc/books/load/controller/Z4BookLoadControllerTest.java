...
/**
 * Unit test for class {@link Z4BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Z4BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Z4BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Z4BookLoadController(sectionHandler).getClass();
        // THEN
    }
