...
/**
 * Unit test for class {@link Z3BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Z3BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Z3BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Z3BookSectionController(sectionHandler).getClass();
        // THEN
    }
