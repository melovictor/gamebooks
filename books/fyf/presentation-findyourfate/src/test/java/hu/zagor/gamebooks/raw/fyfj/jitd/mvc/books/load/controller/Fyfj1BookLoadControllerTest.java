...
/**
 * Unit test for class {@link Fyfj1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Fyfj1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Fyfj1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Fyfj1BookLoadController(sectionHandler).getClass();
        // THEN
    }
