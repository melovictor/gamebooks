...
/**
 * Unit test for class {@link Mf2BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Mf2BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Mf2BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Mf2BookSectionController(sectionHandler).getClass();
        // THEN
    }
