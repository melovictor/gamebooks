...
/**
 * Unit test for class {@link Mf1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Mf1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Mf1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Mf1BookSectionController(sectionHandler).getClass();
        // THEN
    }
