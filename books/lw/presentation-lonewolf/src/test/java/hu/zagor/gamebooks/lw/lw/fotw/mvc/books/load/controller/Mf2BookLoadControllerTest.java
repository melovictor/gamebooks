...
/**
 * Unit test for class {@link Mf2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Mf2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Mf2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Mf2BookLoadController(sectionHandler).getClass();
        // THEN
    }
