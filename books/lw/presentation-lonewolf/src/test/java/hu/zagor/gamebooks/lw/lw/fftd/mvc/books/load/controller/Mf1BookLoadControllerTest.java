...
/**
 * Unit test for class {@link Mf1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Mf1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Mf1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Mf1BookLoadController(sectionHandler).getClass();
        // THEN
    }
