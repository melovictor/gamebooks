...
/**
 * Unit test for class {@link Lw1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Lw1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Lw1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Lw1BookSectionController(sectionHandler).getClass();
        // THEN
    }
