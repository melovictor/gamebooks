...
/**
 * Unit test for class {@link Lw2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Lw2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Lw2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Lw2BookLoadController(sectionHandler).getClass();
        // THEN
    }
