...
/**
 * Unit test for class {@link Cyoar16BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoar16BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoar16BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoar16BookLoadController(sectionHandler).getClass();
        // THEN
    }
