...
/**
 * Unit test for class {@link Vkm4BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Vkm4BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm4BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm4BookSectionController(sectionHandler).getClass();
        // THEN
    }
