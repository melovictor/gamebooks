...
/**
 * Unit test for class {@link Ff5BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff5BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff5BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff5BookLoadController(sectionHandler).getClass();
        // THEN
    }
