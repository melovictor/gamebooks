...
/**
 * Unit test for class {@link Kjk12BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk12BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk12BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk12BookLoadController(sectionHandler).getClass();
        // THEN
    }
