...
public class Ff38BookLoadController extends FfBookLoadController {
     ...
     */
    @Autowired
    public Ff38BookLoadController(@Qualifier("ffSectionHandlingService") final SectionHandlingService sectionHandlingService) {
