...
/**
 * Unit test for class {@link Fh3BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Fh3BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Fh3BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Fh3BookLoadController(sectionHandler).getClass();
        // THEN
    }
