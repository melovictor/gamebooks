...
/**
 * Unit test for class {@link Ff9BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff9BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff9BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff9BookSectionController(sectionHandler).getClass();
        // THEN
    }
