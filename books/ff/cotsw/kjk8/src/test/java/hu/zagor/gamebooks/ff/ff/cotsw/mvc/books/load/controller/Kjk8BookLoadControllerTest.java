...
/**
 * Unit test for class {@link Kjk8BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk8BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk8BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk8BookLoadController(sectionHandler).getClass();
        // THEN
    }
