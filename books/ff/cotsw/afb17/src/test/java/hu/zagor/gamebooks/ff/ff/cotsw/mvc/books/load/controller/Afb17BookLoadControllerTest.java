...
/**
 * Unit test for class {@link Afb17BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb17BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb17BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb17BookLoadController(sectionHandler).getClass();
        // THEN
    }
