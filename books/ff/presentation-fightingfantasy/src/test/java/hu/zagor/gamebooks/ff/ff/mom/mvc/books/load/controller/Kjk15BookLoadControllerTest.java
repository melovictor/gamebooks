...
/**
 * Unit test for class {@link Kjk15BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk15BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk15BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk15BookLoadController(sectionHandler).getClass();
        // THEN
    }
