...
/**
 * Unit test for class {@link Wm5BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Wm5BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Wm5BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Wm5BookLoadController(sectionHandler).getClass();
        // THEN
    }
