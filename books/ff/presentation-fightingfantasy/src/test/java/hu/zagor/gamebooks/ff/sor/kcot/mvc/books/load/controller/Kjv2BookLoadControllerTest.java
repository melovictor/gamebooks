...
/**
 * Unit test for class {@link Kjv2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjv2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjv2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjv2BookLoadController(sectionHandler).getClass();
        // THEN
    }
