...
/**
 * Unit test for class {@link Kjkz26BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkz26BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz26BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz26BookSectionController(sectionHandler).getClass();
        // THEN
    }
