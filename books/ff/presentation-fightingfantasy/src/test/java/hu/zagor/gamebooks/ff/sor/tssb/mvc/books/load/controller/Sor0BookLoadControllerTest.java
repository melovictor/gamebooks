...
/**
 * Unit test for class {@link Sor0BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Sor0BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Sor0BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Sor0BookLoadController(sectionHandler).getClass();
        // THEN
    }
