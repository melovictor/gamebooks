...
/**
 * Unit test for class {@link Kjkzf1p1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkzf1p1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkzf1p1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkzf1p1BookSectionController(sectionHandler).getClass();
        // THEN
    }
