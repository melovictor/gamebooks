...
/**
 * Unit test for class {@link Afb5BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb5BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb5BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb5BookSectionController(sectionHandler).getClass();
        // THEN
    }
