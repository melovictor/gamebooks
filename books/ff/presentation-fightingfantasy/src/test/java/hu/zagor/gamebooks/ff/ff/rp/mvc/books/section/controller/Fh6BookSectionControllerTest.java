...
/**
 * Unit test for class {@link Fh6BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Fh6BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Fh6BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Fh6BookSectionController(sectionHandler).getClass();
        // THEN
    }
