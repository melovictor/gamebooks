...
/**
 * Unit test for class {@link Kjk17BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk17BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk17BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk17BookLoadController(sectionHandler).getClass();
        // THEN
    }
