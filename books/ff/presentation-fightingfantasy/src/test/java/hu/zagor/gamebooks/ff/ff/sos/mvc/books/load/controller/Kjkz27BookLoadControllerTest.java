...
/**
 * Unit test for class {@link Kjkz27BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkz27BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz27BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz27BookLoadController(sectionHandler).getClass();
        // THEN
    }
