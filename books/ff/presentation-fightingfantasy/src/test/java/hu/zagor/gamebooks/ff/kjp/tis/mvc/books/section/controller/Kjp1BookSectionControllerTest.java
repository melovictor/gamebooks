...
/**
 * Unit test for class {@link Kjp1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjp1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjp1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjp1BookSectionController(sectionHandler).getClass();
        // THEN
    }
