...
/**
 * Unit test for class {@link Kjkzf1p3BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkzf1p3BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkzf1p3BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkzf1p3BookLoadController(sectionHandler).getClass();
        // THEN
    }
