...
/**
 * Unit test for class {@link Afb1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb1BookLoadController(sectionHandler).getClass();
        // THEN
    }
