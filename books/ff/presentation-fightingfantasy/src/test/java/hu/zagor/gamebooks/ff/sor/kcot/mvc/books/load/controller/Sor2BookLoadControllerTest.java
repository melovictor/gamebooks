...
/**
 * Unit test for class {@link Sor2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Sor2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Sor2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Sor2BookLoadController(sectionHandler).getClass();
        // THEN
    }
