...
/**
 * Unit test for class {@link Afb2BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb2BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb2BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb2BookSectionController(sectionHandler).getClass();
        // THEN
    }
