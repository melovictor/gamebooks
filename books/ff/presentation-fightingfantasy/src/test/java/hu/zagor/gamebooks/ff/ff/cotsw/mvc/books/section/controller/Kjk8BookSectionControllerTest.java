...
/**
 * Unit test for class {@link Kjk8BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk8BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk8BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk8BookSectionController(sectionHandler).getClass();
        // THEN
    }
