...
/**
 * Unit test for class {@link Kjkz4BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkz4BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz4BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz4BookSectionController(sectionHandler).getClass();
        // THEN
    }
