...
/**
 * Unit test for class {@link Ff26BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff26BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff26BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff26BookLoadController(sectionHandler).getClass();
        // THEN
    }
