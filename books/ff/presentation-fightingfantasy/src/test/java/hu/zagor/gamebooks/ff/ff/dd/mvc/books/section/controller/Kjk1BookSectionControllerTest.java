...
/**
 * Unit test for class {@link Kjk1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk1BookSectionController(sectionHandler).getClass();
        // THEN
    }
