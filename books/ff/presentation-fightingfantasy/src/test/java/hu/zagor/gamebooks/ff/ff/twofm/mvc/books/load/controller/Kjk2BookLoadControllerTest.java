...
/**
 * Unit test for class {@link Kjk2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk2BookLoadController(sectionHandler).getClass();
        // THEN
    }
