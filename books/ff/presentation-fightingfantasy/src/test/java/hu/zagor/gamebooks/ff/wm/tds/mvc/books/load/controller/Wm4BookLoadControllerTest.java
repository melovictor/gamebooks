...
/**
 * Unit test for class {@link Wm4BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Wm4BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Wm4BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Wm4BookLoadController(sectionHandler).getClass();
        // THEN
    }
