...
/**
 * Unit test for class {@link Afb5BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb5BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb5BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb5BookLoadController(sectionHandler).getClass();
        // THEN
    }
