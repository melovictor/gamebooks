...
/**
 * Unit test for class {@link Kjkzf2p2BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkzf2p2BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkzf2p2BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkzf2p2BookSectionController(sectionHandler).getClass();
        // THEN
    }
