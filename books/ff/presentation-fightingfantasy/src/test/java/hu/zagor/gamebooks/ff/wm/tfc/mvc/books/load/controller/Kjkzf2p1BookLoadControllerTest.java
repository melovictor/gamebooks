...
/**
 * Unit test for class {@link Kjkzf2p1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkzf2p1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkzf2p1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkzf2p1BookLoadController(sectionHandler).getClass();
        // THEN
    }
