...
/**
 * Unit test for class {@link Kjk5BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk5BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk5BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk5BookSectionController(sectionHandler).getClass();
        // THEN
    }
