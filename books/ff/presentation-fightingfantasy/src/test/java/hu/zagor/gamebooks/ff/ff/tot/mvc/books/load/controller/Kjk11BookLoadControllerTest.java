...
/**
 * Unit test for class {@link Kjk11BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk11BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk11BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk11BookLoadController(sectionHandler).getClass();
        // THEN
    }
