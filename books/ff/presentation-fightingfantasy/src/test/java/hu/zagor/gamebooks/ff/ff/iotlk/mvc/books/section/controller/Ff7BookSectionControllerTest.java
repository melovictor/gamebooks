...
/**
 * Unit test for class {@link Ff7BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff7BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff7BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff7BookSectionController(sectionHandler).getClass();
        // THEN
    }
