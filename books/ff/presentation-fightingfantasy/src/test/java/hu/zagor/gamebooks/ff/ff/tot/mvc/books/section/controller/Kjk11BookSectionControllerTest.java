...
/**
 * Unit test for class {@link Kjk11BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk11BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk11BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk11BookSectionController(sectionHandler).getClass();
        // THEN
    }
