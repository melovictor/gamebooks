...
/**
 * Unit test for class {@link Kjk10BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk10BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk10BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk10BookLoadController(sectionHandler).getClass();
        // THEN
    }
