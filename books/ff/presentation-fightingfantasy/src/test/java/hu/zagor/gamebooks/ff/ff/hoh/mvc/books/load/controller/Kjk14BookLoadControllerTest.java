...
/**
 * Unit test for class {@link Kjk14BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk14BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk14BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk14BookLoadController(sectionHandler).getClass();
        // THEN
    }
