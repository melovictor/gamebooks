...
/**
 * Unit test for class {@link Ff10BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff10BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff10BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff10BookLoadController(sectionHandler).getClass();
        // THEN
    }
