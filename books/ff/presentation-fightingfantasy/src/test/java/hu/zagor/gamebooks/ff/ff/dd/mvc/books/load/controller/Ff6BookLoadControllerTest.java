...
/**
 * Unit test for class {@link Ff6BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff6BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff6BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff6BookLoadController(sectionHandler).getClass();
        // THEN
    }
