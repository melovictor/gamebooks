...
/**
 * Unit test for class {@link Wm11BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Wm11BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Wm11BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Wm11BookLoadController(sectionHandler).getClass();
        // THEN
    }
