...
/**
 * Unit test for class {@link Ff23BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff23BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff23BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff23BookLoadController(sectionHandler).getClass();
        // THEN
    }
