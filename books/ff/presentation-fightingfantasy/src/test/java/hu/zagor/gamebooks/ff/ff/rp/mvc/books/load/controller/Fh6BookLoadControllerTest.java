...
/**
 * Unit test for class {@link Fh6BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Fh6BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Fh6BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Fh6BookLoadController(sectionHandler).getClass();
        // THEN
    }
