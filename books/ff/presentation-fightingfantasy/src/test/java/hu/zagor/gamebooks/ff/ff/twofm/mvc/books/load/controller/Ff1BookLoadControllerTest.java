...
/**
 * Unit test for class {@link Ff1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff1BookLoadController(sectionHandler).getClass();
        // THEN
    }
