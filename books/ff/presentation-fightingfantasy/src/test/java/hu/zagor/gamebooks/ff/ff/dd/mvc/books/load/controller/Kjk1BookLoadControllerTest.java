...
/**
 * Unit test for class {@link Kjk1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk1BookLoadController(sectionHandler).getClass();
        // THEN
    }
