...
/**
 * Unit test for class {@link Ff36BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff36BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff36BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff36BookSectionController(sectionHandler).getClass();
        // THEN
    }
