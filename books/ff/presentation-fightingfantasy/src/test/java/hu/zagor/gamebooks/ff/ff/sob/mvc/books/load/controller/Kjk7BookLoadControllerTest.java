...
/**
 * Unit test for class {@link Kjk7BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk7BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk7BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk7BookLoadController(sectionHandler).getClass();
        // THEN
    }
