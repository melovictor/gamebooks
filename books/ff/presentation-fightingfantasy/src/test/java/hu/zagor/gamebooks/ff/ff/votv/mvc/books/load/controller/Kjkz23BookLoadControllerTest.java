...
/**
 * Unit test for class {@link Kjkz23BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkz23BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz23BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz23BookLoadController(sectionHandler).getClass();
        // THEN
    }
