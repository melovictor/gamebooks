...
/**
 * Unit test for class {@link Kjv3BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjv3BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjv3BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjv3BookSectionController(sectionHandler).getClass();
        // THEN
    }
