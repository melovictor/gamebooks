...
/**
 * Unit test for class {@link Fh1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Fh1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Fh1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Fh1BookSectionController(sectionHandler).getClass();
        // THEN
    }
