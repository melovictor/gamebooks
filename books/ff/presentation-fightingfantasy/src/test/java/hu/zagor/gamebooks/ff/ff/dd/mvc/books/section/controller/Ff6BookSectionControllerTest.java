...
/**
 * Unit test for class {@link Ff6BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff6BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff6BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff6BookSectionController(sectionHandler).getClass();
        // THEN
    }
