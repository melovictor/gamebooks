...
/**
 * Unit test for class {@link Kjk4BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk4BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk4BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk4BookLoadController(sectionHandler).getClass();
        // THEN
    }
