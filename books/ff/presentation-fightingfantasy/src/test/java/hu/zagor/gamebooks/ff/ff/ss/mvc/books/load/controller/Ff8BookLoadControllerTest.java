...
/**
 * Unit test for class {@link Ff8BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff8BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff8BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff8BookLoadController(sectionHandler).getClass();
        // THEN
    }
