...
/**
 * Unit test for class {@link Afb17BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb17BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb17BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb17BookSectionController(sectionHandler).getClass();
        // THEN
    }
