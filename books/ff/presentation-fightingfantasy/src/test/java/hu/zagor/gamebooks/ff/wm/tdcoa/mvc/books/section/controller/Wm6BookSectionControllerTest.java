...
/**
 * Unit test for class {@link Wm6BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Wm6BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Wm6BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Wm6BookSectionController(sectionHandler).getClass();
        // THEN
    }
