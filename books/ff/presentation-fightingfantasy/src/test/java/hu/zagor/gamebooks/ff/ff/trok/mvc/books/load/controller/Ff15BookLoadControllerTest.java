...
/**
 * Unit test for class {@link Ff15BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff15BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff15BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff15BookLoadController(sectionHandler).getClass();
        // THEN
    }
