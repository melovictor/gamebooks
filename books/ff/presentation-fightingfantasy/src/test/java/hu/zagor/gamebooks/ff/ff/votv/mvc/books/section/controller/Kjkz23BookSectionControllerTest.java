...
/**
 * Unit test for class {@link Kjkz23BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkz23BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz23BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz23BookSectionController(sectionHandler).getClass();
        // THEN
    }
