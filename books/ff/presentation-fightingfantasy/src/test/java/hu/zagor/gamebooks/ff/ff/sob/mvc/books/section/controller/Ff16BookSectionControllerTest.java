...
/**
 * Unit test for class {@link Ff16BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff16BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff16BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff16BookSectionController(sectionHandler).getClass();
        // THEN
    }
