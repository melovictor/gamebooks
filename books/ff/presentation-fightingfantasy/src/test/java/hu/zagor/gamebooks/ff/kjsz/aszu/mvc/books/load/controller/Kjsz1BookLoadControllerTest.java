package hu.zagor.gamebooks.ff.kjsz.aszu.mvc.books.load.controller;
...
/**
 * Unit test for class {@link Kjsz1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjsz1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjsz1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjsz1BookLoadController(sectionHandler).getClass();
        // THEN
    }
