...
/**
 * Unit test for class {@link Ff25BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff25BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff25BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff25BookLoadController(sectionHandler).getClass();
        // THEN
    }
