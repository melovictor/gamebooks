...
/**
 * Unit test for class {@link Ff36BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff36BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff36BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff36BookLoadController(sectionHandler).getClass();
        // THEN
    }
