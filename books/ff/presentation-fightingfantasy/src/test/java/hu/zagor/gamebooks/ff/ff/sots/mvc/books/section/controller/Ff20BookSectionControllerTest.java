...
/**
 * Unit test for class {@link Ff20BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff20BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff20BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff20BookSectionController(sectionHandler).getClass();
        // THEN
    }
