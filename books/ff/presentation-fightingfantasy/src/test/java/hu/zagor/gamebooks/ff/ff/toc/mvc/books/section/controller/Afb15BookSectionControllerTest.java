...
/**
 * Unit test for class {@link Afb15BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb15BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb15BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb15BookSectionController(sectionHandler).getClass();
        // THEN
    }
