...
/**
 * Unit test for class {@link Ff34BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff34BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff34BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff34BookLoadController(sectionHandler).getClass();
        // THEN
    }
