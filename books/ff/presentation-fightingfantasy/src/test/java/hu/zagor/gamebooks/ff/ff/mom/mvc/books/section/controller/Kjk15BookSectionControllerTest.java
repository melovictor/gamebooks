...
/**
 * Unit test for class {@link Kjk15BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk15BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk15BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk15BookSectionController(sectionHandler).getClass();
        // THEN
    }
