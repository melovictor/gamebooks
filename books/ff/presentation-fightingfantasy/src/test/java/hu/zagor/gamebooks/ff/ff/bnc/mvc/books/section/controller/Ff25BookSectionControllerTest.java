...
/**
 * Unit test for class {@link Ff25BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff25BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff25BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff25BookSectionController(sectionHandler).getClass();
        // THEN
    }
