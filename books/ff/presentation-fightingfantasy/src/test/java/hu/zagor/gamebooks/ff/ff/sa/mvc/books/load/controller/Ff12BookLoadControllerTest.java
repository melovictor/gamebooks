...
/**
 * Unit test for class {@link Ff12BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff12BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff12BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff12BookLoadController(sectionHandler).getClass();
        // THEN
    }
