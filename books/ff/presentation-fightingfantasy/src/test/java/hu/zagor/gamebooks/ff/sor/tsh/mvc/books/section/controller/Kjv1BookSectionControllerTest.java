...
/**
 * Unit test for class {@link Kjv1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjv1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjv1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjv1BookSectionController(sectionHandler).getClass();
        // THEN
    }
