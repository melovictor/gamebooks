...
/**
 * Unit test for class {@link Kjk14BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk14BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk14BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk14BookSectionController(sectionHandler).getClass();
        // THEN
    }
