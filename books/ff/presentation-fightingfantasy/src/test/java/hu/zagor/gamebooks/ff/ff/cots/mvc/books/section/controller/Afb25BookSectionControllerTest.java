...
/**
 * Unit test for class {@link Afb25BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb25BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb25BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb25BookSectionController(sectionHandler).getClass();
        // THEN
    }
