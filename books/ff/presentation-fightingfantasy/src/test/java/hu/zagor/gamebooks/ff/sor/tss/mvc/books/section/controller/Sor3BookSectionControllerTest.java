...
/**
 * Unit test for class {@link Sor3BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Sor3BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Sor3BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Sor3BookSectionController(sectionHandler).getClass();
        // THEN
    }
