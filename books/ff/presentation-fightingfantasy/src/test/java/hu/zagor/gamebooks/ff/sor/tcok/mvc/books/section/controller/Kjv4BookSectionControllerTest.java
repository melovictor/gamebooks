...
/**
 * Unit test for class {@link Kjv4BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjv4BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjv4BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjv4BookSectionController(sectionHandler).getClass();
        // THEN
    }
