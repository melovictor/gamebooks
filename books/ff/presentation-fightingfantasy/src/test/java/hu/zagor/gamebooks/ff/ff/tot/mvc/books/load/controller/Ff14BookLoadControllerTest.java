...
/**
 * Unit test for class {@link Ff14BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff14BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff14BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff14BookLoadController(sectionHandler).getClass();
        // THEN
    }
