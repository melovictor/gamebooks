...
/**
 * Unit test for class {@link Afb1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb1BookSectionController(sectionHandler).getClass();
        // THEN
    }
