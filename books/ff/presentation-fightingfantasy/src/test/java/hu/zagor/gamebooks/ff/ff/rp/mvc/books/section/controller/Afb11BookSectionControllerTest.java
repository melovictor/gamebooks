...
/**
 * Unit test for class {@link Afb11BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb11BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb11BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb11BookSectionController(sectionHandler).getClass();
        // THEN
    }
