...
/**
 * Unit test for class {@link Kjk2BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk2BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk2BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk2BookSectionController(sectionHandler).getClass();
        // THEN
    }
