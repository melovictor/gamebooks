...
/**
 * Unit test for class {@link Sor4BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Sor4BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Sor4BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Sor4BookLoadController(sectionHandler).getClass();
        // THEN
    }
