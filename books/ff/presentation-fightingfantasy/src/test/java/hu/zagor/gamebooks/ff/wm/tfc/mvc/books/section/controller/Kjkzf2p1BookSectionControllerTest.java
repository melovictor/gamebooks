...
/**
 * Unit test for class {@link Kjkzf2p1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkzf2p1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkzf2p1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkzf2p1BookSectionController(sectionHandler).getClass();
        // THEN
    }
