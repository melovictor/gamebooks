...
/**
 * Unit test for class {@link Ff38BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff38BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff38BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff38BookSectionController(sectionHandler).getClass();
        // THEN
    }
