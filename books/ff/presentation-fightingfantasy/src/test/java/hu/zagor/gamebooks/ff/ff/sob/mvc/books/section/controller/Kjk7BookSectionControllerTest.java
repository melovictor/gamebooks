...
/**
 * Unit test for class {@link Kjk7BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk7BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk7BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk7BookSectionController(sectionHandler).getClass();
        // THEN
    }
