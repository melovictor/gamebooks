...
/**
 * Unit test for class {@link Ff16BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff16BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff16BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff16BookLoadController(sectionHandler).getClass();
        // THEN
    }
