...
/**
 * Unit test for class {@link Ff20BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff20BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff20BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff20BookLoadController(sectionHandler).getClass();
        // THEN
    }
