...
/**
 * Unit test for class {@link Wm8BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Wm8BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Wm8BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Wm8BookSectionController(sectionHandler).getClass();
        // THEN
    }
