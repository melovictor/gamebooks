...
/**
 * Unit test for class {@link Ff2BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff2BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff2BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff2BookSectionController(sectionHandler).getClass();
        // THEN
    }
