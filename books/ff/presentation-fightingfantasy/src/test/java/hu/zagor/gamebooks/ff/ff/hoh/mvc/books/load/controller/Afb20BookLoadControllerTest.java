...
/**
 * Unit test for class {@link Afb20BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb20BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb20BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb20BookLoadController(sectionHandler).getClass();
        // THEN
    }
