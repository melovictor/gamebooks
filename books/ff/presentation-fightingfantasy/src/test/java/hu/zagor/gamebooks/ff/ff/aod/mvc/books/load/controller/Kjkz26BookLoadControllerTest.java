...
/**
 * Unit test for class {@link Kjkz26BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkz26BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz26BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz26BookLoadController(sectionHandler).getClass();
        // THEN
    }
