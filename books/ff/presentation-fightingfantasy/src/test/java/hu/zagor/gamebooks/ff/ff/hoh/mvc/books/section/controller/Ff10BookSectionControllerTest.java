...
/**
 * Unit test for class {@link Ff10BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff10BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff10BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff10BookSectionController(sectionHandler).getClass();
        // THEN
    }
