...
/**
 * Unit test for class {@link Kjv3BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjv3BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjv3BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjv3BookLoadController(sectionHandler).getClass();
        // THEN
    }
