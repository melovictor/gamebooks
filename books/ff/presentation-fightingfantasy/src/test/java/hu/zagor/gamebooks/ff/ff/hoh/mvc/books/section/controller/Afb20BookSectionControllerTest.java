...
/**
 * Unit test for class {@link Afb20BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb20BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb20BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb20BookSectionController(sectionHandler).getClass();
        // THEN
    }
