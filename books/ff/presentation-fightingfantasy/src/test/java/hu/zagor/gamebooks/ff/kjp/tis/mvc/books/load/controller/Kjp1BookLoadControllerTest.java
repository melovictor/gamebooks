...
/**
 * Unit test for class {@link Kjp1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjp1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjp1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjp1BookLoadController(sectionHandler).getClass();
        // THEN
    }
