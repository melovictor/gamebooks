...
/**
 * Unit test for class {@link Ff8BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff8BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff8BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff8BookSectionController(sectionHandler).getClass();
        // THEN
    }
