...
/**
 * Unit test for class {@link Afb4BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb4BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb4BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb4BookSectionController(sectionHandler).getClass();
        // THEN
    }
