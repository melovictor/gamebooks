...
/**
 * Unit test for class {@link Afb15BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb15BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb15BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb15BookLoadController(sectionHandler).getClass();
        // THEN
    }
