...
/**
 * Unit test for class {@link Sor1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Sor1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Sor1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Sor1BookLoadController(sectionHandler).getClass();
        // THEN
    }
