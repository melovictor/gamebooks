...
/**
 * Unit test for class {@link Kjk9BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk9BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk9BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk9BookLoadController(sectionHandler).getClass();
        // THEN
    }
