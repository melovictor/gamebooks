...
/**
 * Unit test for class {@link Ff11BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff11BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff11BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff11BookSectionController(sectionHandler).getClass();
        // THEN
    }
