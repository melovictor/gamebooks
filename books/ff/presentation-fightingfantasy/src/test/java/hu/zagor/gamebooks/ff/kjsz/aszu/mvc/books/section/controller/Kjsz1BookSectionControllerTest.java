...
/**
 * Unit test for class {@link Kjsz1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjsz1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjsz1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjsz1BookSectionController(sectionHandler).getClass();
        // THEN
    }
