...
/**
 * Unit test for class {@link Ff1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff1BookSectionController(sectionHandler).getClass();
        // THEN
    }
