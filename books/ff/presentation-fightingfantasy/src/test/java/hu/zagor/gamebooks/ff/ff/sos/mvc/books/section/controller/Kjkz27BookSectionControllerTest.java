...
/**
 * Unit test for class {@link Kjkz27BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkz27BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz27BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz27BookSectionController(sectionHandler).getClass();
        // THEN
    }
