...
/**
 * Unit test for class {@link Afb4BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb4BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb4BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb4BookLoadController(sectionHandler).getClass();
        // THEN
    }
