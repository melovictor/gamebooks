...
/**
 * Unit test for class {@link Kjk4BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk4BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk4BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk4BookSectionController(sectionHandler).getClass();
        // THEN
    }
