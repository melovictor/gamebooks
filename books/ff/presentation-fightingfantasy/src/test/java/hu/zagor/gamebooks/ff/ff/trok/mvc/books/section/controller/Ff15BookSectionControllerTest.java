...
/**
 * Unit test for class {@link Ff15BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff15BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff15BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff15BookSectionController(sectionHandler).getClass();
        // THEN
    }
