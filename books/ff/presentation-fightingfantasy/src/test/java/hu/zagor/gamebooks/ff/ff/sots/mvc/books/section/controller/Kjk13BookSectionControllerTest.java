...
/**
 * Unit test for class {@link Kjk13BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk13BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk13BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk13BookSectionController(sectionHandler).getClass();
        // THEN
    }
