...
/**
 * Unit test for class {@link Sor3BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Sor3BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Sor3BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Sor3BookLoadController(sectionHandler).getClass();
        // THEN
    }
