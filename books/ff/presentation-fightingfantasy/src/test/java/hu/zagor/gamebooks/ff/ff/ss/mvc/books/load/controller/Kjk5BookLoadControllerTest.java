...
/**
 * Unit test for class {@link Kjk5BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk5BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk5BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk5BookLoadController(sectionHandler).getClass();
        // THEN
    }
