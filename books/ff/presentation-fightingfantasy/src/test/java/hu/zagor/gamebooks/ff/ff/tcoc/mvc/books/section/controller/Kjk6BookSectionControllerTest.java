...
/**
 * Unit test for class {@link Kjk6BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk6BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk6BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk6BookSectionController(sectionHandler).getClass();
        // THEN
    }
