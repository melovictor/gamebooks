...
/**
 * Unit test for class {@link Kjv2BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjv2BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjv2BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjv2BookSectionController(sectionHandler).getClass();
        // THEN
    }
