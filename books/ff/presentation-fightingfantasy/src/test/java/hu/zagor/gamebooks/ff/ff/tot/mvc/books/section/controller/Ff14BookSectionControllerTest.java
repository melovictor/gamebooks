...
/**
 * Unit test for class {@link Ff14BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff14BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff14BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff14BookSectionController(sectionHandler).getClass();
        // THEN
    }
