...
/**
 * Unit test for class {@link Kjkzf1p2BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkzf1p2BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkzf1p2BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkzf1p2BookSectionController(sectionHandler).getClass();
        // THEN
    }
