...
/**
 * Unit test for class {@link Kjkz9BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkz9BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz9BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz9BookLoadController(sectionHandler).getClass();
        // THEN
    }
