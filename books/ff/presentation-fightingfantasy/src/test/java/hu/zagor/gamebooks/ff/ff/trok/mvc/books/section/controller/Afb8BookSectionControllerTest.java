...
/**
 * Unit test for class {@link Afb8BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb8BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb8BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb8BookSectionController(sectionHandler).getClass();
        // THEN
    }
