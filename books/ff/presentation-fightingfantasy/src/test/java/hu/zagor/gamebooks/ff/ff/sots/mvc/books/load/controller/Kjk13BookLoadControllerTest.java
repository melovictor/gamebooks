...
/**
 * Unit test for class {@link Kjk13BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk13BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk13BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk13BookLoadController(sectionHandler).getClass();
        // THEN
    }
