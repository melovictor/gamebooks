...
/**
 * Unit test for class {@link Fh1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Fh1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Fh1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Fh1BookLoadController(sectionHandler).getClass();
        // THEN
    }
