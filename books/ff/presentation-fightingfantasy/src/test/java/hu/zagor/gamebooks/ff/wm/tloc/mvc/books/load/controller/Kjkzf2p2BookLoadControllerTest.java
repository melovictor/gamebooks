...
/**
 * Unit test for class {@link Kjkzf2p2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkzf2p2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkzf2p2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkzf2p2BookLoadController(sectionHandler).getClass();
        // THEN
    }
