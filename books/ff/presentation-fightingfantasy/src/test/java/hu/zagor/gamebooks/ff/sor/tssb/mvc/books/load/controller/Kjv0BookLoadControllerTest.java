...
/**
 * Unit test for class {@link Kjv0BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjv0BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjv0BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjv0BookLoadController(sectionHandler).getClass();
        // THEN
    }
