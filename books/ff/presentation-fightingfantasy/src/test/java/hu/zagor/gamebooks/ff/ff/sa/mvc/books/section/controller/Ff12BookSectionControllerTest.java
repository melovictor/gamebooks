...
/**
 * Unit test for class {@link Ff12BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff12BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff12BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff12BookSectionController(sectionHandler).getClass();
        // THEN
    }
