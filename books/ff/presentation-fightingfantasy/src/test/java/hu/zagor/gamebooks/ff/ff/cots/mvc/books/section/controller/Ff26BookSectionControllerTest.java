...
/**
 * Unit test for class {@link Ff26BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff26BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff26BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff26BookSectionController(sectionHandler).getClass();
        // THEN
    }
