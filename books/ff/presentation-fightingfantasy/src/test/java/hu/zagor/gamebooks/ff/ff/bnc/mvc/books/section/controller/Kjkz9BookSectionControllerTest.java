...
/**
 * Unit test for class {@link Kjkz9BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkz9BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz9BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkz9BookSectionController(sectionHandler).getClass();
        // THEN
    }
