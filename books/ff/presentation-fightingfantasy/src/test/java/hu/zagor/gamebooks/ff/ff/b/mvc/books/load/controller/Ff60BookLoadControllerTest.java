...
/**
 * Unit test for class {@link Ff60BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff60BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff60BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff60BookLoadController(sectionHandler).getClass();
        // THEN
    }
