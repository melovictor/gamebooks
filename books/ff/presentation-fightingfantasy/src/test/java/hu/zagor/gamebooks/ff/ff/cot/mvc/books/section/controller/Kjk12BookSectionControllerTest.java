...
/**
 * Unit test for class {@link Kjk12BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk12BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk12BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk12BookSectionController(sectionHandler).getClass();
        // THEN
    }
