...
/**
 * Unit test for class {@link Kjkzf1p2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjkzf1p2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkzf1p2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjkzf1p2BookLoadController(sectionHandler).getClass();
        // THEN
    }
