...
/**
 * Unit test for class {@link Afb8BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb8BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb8BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb8BookLoadController(sectionHandler).getClass();
        // THEN
    }
