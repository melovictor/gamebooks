...
/**
 * Unit test for class {@link Pt14BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Pt14BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Pt14BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Pt14BookLoadController(sectionHandler).getClass();
        // THEN
    }
