...
/**
 * Unit test for class {@link Kjk17BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk17BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk17BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk17BookSectionController(sectionHandler).getClass();
        // THEN
    }
