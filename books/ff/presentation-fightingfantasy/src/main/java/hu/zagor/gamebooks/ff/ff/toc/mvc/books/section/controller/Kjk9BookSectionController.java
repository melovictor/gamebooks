...
public class Kjk9BookSectionController extends Ff21BookSectionController {
     ...
     */
    @Autowired
    public Kjk9BookSectionController(@Qualifier("ffSectionHandlingService") final SectionHandlingService sectionHandlingService) {
