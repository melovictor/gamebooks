...
/**
 * Post section handler for section 242, FF8.
 * @author Tamas_Szekeres
 */
@Component
public class Ff8Section242PostHandler extends FfCustomPrePostSectionHandler {
    private static final double CHEATED_BY = 0.4;
    ...
    public void handle(final Model model, final HttpSessionWrapper wrapper, final FfBookInformations info, final boolean changedSection) {
        ...
        character.setGold((int) (character.getGold() * CHEATED_BY));
    }
