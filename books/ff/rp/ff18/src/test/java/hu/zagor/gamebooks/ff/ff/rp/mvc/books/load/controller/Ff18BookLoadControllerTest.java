...
/**
 * Unit test for class {@link Ff18BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff18BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff18BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff18BookLoadController(sectionHandler).getClass();
        // THEN
    }
