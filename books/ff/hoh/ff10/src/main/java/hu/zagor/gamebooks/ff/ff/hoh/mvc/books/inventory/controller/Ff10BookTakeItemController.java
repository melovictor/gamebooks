...
public class Ff10BookTakeItemController extends FfBookTakeItemController {
    ...
    @Override
    public int doHandleItemTake(final HttpServletRequest request, final String itemId, final int amount) {
        final int handleItemTake = super.doHandleItemTake(request, itemId, amount);
