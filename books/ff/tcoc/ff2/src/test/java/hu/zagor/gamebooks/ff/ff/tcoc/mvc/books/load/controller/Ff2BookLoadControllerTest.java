...
/**
 * Unit test for class {@link Ff2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff2BookLoadController(sectionHandler).getClass();
        // THEN
    }
