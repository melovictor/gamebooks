...
/**
 * Unit test for class {@link Kjk6BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Kjk6BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk6BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Kjk6BookLoadController(sectionHandler).getClass();
        // THEN
    }
