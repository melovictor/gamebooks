...
/**
 * Unit test for class {@link Afb25BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Afb25BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Afb25BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Afb25BookLoadController(sectionHandler).getClass();
        // THEN
    }
