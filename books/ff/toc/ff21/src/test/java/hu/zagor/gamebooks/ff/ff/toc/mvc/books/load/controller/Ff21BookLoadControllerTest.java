...
/**
 * Unit test for class {@link Ff21BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Ff21BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Ff21BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Ff21BookLoadController(sectionHandler).getClass();
        // THEN
    }
