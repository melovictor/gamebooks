...
public class Ff21BookLoadController extends FfBookLoadController {
     ...
     */
    @Autowired
    public Ff21BookLoadController(@Qualifier("ffSectionHandlingService") final SectionHandlingService sectionHandlingService) {
