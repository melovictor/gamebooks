...
/**
 * Unit test for class {@link Sc1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Sc1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Sc1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Sc1BookLoadController(sectionHandler).getClass();
        // THEN
    }
