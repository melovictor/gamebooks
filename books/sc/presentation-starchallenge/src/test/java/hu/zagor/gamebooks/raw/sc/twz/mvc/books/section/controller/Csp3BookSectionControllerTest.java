...
/**
 * Unit test for class {@link Csp3BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Csp3BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Csp3BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Csp3BookSectionController(sectionHandler).getClass();
        // THEN
    }
