...
/**
 * Unit test for class {@link Csp2BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Csp2BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Csp2BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Csp2BookSectionController(sectionHandler).getClass();
        // THEN
    }
