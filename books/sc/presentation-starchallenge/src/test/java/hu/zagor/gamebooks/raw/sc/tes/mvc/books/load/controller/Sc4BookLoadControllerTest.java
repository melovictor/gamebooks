...
/**
 * Unit test for class {@link Sc4BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Sc4BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Sc4BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Sc4BookLoadController(sectionHandler).getClass();
        // THEN
    }
