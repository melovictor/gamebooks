...
/**
 * Unit test for class {@link Csp3BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Csp3BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Csp3BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Csp3BookLoadController(sectionHandler).getClass();
        // THEN
    }
