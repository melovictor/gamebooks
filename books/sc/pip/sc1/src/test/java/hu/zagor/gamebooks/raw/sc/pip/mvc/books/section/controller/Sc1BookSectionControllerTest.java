...
/**
 * Unit test for class {@link Sc1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Sc1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Sc1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Sc1BookSectionController(sectionHandler).getClass();
        // THEN
    }
