...
/**
 * Unit test for class {@link Sc2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Sc2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Sc2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Sc2BookLoadController(sectionHandler).getClass();
        // THEN
    }
