...
/**
 * Unit test for class {@link Sc2BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Sc2BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Sc2BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Sc2BookSectionController(sectionHandler).getClass();
        // THEN
    }
