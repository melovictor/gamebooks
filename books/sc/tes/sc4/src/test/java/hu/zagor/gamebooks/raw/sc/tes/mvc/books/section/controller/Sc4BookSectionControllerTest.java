...
/**
 * Unit test for class {@link Sc4BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Sc4BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Sc4BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Sc4BookSectionController(sectionHandler).getClass();
        // THEN
    }
