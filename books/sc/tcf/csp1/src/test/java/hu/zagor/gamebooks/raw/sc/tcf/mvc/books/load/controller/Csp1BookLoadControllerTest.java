...
/**
 * Unit test for class {@link Csp1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Csp1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Csp1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Csp1BookLoadController(sectionHandler).getClass();
        // THEN
    }
