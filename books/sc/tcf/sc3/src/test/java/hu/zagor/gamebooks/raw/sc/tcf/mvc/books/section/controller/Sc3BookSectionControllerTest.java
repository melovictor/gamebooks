...
/**
 * Unit test for class {@link Sc3BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Sc3BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Sc3BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Sc3BookSectionController(sectionHandler).getClass();
        // THEN
    }
