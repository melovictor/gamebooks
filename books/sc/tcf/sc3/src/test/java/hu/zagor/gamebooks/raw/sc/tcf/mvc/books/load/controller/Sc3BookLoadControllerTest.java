...
/**
 * Unit test for class {@link Sc3BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Sc3BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Sc3BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Sc3BookLoadController(sectionHandler).getClass();
        // THEN
    }
