...
/**
 * Unit test for class {@link Sc6BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Sc6BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Sc6BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Sc6BookSectionController(sectionHandler).getClass();
        // THEN
    }
