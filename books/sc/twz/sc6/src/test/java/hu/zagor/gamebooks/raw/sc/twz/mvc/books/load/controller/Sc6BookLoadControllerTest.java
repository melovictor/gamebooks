...
/**
 * Unit test for class {@link Sc6BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Sc6BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Sc6BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Sc6BookLoadController(sectionHandler).getClass();
        // THEN
    }
