...
/**
 * Unit test for class {@link Wm5BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Wm5BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Wm5BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Wm5BookSectionController(sectionHandler).getClass();
        // THEN
    }
