...
/**
 * Unit test for class {@link Wm4BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Wm4BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Wm4BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Wm4BookSectionController(sectionHandler).getClass();
        // THEN
    }
