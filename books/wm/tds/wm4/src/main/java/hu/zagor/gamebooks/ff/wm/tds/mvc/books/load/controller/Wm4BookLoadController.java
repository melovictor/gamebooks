...
public class Wm4BookLoadController extends FfBookLoadController {
     ...
     */
    @Autowired
    public Wm4BookLoadController(@Qualifier("ffSectionHandlingService") final SectionHandlingService sectionHandlingService) {
