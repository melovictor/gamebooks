...
/**
 * Unit test for class {@link Egylany2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Egylany2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Egylany2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Egylany2BookLoadController(sectionHandler).getClass();
        // THEN
    }
