...
/**
 * Unit test for class {@link Agirl1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Agirl1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Agirl1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Agirl1BookLoadController(sectionHandler).getClass();
        // THEN
    }
