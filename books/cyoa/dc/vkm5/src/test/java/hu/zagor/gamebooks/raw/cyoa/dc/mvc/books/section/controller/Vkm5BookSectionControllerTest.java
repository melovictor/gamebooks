...
/**
 * Unit test for class {@link Vkm5BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Vkm5BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm5BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm5BookSectionController(sectionHandler).getClass();
        // THEN
    }
