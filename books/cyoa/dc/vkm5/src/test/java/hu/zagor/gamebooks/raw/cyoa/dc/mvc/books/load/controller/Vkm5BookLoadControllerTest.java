...
/**
 * Unit test for class {@link Vkm5BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Vkm5BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm5BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm5BookLoadController(sectionHandler).getClass();
        // THEN
    }
