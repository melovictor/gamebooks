...
/**
 * Unit test for class {@link Cyoa9BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa9BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa9BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa9BookLoadController(sectionHandler).getClass();
        // THEN
    }
