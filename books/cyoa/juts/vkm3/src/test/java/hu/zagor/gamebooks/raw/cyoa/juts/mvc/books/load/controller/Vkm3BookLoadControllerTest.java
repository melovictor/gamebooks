...
/**
 * Unit test for class {@link Vkm3BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Vkm3BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm3BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm3BookLoadController(sectionHandler).getClass();
        // THEN
    }
