...
public class Cyoa1BookSectionController extends RawBookSectionController {
     ...
     */
    @Autowired
    public Cyoa1BookSectionController(@Qualifier("rawSectionHandlingService") final SectionHandlingService sectionHandlingService) {
