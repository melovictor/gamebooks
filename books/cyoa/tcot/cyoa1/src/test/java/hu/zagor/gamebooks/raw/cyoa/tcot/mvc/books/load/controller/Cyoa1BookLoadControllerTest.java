...
/**
 * Unit test for class {@link Cyoa1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa1BookLoadController(sectionHandler).getClass();
        // THEN
    }
