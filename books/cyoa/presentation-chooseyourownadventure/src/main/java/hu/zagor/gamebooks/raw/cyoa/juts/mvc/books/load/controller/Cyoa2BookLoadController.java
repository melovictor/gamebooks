package hu.zagor.gamebooks.raw.cyoa.juts.mvc.books.load.controller;
...
public class Cyoa2BookLoadController extends RawBookLoadController {
     ...
     */
    @Autowired
    public Cyoa2BookLoadController(@Qualifier("rawSectionHandlingService") final SectionHandlingService sectionHandlingService) {
