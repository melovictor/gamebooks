...
public class Vkm4BookSectionController extends RawBookSectionController {
     ...
     */
    @Autowired
    public Vkm4BookSectionController(@Qualifier("rawSectionHandlingService") final SectionHandlingService sectionHandlingService) {
