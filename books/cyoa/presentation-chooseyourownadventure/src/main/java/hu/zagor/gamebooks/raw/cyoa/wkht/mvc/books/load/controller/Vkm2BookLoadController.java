...
public class Vkm2BookLoadController extends RawBookLoadController {
     ...
     */
    @Autowired
    public Vkm2BookLoadController(@Qualifier("rawSectionHandlingService") final SectionHandlingService sectionHandlingService) {
