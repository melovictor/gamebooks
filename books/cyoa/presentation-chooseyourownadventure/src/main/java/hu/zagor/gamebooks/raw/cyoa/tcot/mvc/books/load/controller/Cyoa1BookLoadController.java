...
public class Cyoa1BookLoadController extends RawBookLoadController {
     ...
     */
    @Autowired
    public Cyoa1BookLoadController(@Qualifier("rawSectionHandlingService") final SectionHandlingService sectionHandlingService) {
