...
public class Cyoar16BookSectionController extends RawBookSectionController {
     ...
     */
    @Autowired
    public Cyoar16BookSectionController(@Qualifier("rawSectionHandlingService") final SectionHandlingService sectionHandlingService) {
