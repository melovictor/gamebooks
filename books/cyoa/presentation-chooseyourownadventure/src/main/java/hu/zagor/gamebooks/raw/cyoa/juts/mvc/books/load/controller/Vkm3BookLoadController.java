...
public class Vkm3BookLoadController extends RawBookLoadController {
     ...
     */
    @Autowired
    public Vkm3BookLoadController(@Qualifier("rawSectionHandlingService") final SectionHandlingService sectionHandlingService) {
