...
/**
 * Unit test for class {@link Cyoa2BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa2BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa2BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa2BookSectionController(sectionHandler).getClass();
        // THEN
    }
