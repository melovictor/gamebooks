...
/**
 * Unit test for class {@link Cyoa7BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa7BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa7BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa7BookLoadController(sectionHandler).getClass();
        // THEN
    }
