...
/**
 * Unit test for class {@link Cyoa16BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa16BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa16BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa16BookLoadController(sectionHandler).getClass();
        // THEN
    }
