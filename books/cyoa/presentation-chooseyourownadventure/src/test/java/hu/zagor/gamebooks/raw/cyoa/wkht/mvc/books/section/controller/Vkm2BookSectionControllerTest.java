...
/**
 * Unit test for class {@link Vkm2BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Vkm2BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm2BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm2BookSectionController(sectionHandler).getClass();
        // THEN
    }
