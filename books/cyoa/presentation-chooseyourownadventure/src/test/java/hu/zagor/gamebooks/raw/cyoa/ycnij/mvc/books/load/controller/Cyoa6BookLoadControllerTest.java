...
/**
 * Unit test for class {@link Cyoa6BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa6BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa6BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa6BookLoadController(sectionHandler).getClass();
        // THEN
    }
