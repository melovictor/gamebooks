...
/**
 * Unit test for class {@link Cyoa3BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa3BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa3BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa3BookLoadController(sectionHandler).getClass();
        // THEN
    }
