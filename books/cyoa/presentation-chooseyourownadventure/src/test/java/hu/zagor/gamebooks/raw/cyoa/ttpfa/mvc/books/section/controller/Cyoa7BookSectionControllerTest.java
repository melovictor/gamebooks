...
/**
 * Unit test for class {@link Cyoa7BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa7BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa7BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa7BookSectionController(sectionHandler).getClass();
        // THEN
    }
