...
/**
 * Unit test for class {@link Cyoa1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa1BookSectionController(sectionHandler).getClass();
        // THEN
    }
