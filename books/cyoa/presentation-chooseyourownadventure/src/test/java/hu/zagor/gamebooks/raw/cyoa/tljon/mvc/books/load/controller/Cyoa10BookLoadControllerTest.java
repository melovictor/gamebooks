...
/**
 * Unit test for class {@link Cyoa10BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa10BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa10BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa10BookLoadController(sectionHandler).getClass();
        // THEN
    }
