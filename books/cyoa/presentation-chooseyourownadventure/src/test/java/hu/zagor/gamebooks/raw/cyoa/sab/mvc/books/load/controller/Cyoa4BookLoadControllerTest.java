...
/**
 * Unit test for class {@link Cyoa4BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa4BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa4BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa4BookLoadController(sectionHandler).getClass();
        // THEN
    }
