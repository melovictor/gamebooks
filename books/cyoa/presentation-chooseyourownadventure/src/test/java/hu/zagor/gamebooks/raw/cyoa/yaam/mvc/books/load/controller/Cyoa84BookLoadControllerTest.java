...
/**
 * Unit test for class {@link Cyoa84BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa84BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa84BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa84BookLoadController(sectionHandler).getClass();
        // THEN
    }
