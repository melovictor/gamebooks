...
/**
 * Unit test for class {@link Cyoa8BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa8BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa8BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa8BookSectionController(sectionHandler).getClass();
        // THEN
    }
