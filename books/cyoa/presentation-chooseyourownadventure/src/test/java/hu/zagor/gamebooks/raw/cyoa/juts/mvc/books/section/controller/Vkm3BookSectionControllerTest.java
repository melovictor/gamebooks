...
/**
 * Unit test for class {@link Vkm3BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Vkm3BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm3BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm3BookSectionController(sectionHandler).getClass();
        // THEN
    }
