...
/**
 * Unit test for class {@link Cyoa5BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa5BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa5BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa5BookLoadController(sectionHandler).getClass();
        // THEN
    }
