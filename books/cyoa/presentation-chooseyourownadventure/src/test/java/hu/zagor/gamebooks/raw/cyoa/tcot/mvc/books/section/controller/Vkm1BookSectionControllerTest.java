...
/**
 * Unit test for class {@link Vkm1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Vkm1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm1BookSectionController(sectionHandler).getClass();
        // THEN
    }
