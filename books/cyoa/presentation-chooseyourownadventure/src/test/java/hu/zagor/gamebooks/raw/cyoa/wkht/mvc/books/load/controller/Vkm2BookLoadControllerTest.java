...
/**
 * Unit test for class {@link Vkm2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Vkm2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm2BookLoadController(sectionHandler).getClass();
        // THEN
    }
