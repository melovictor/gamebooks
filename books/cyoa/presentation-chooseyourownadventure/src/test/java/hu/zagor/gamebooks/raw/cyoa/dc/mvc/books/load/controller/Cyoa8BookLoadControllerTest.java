...
/**
 * Unit test for class {@link Cyoa8BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa8BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa8BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa8BookLoadController(sectionHandler).getClass();
        // THEN
    }
