package hu.zagor.gamebooks.raw.cyoar.sw.mvc.books.load.controller;
...
/**
 * Unit test for class {@link Cyoar23BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoar23BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoar23BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoar23BookLoadController(sectionHandler).getClass();
        // THEN
    }
