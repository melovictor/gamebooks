...
/**
 * Unit test for class {@link Vkm1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Vkm1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Vkm1BookLoadController(sectionHandler).getClass();
        // THEN
    }
