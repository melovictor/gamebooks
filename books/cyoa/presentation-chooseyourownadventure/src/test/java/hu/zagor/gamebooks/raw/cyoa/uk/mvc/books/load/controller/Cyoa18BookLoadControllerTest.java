...
/**
 * Unit test for class {@link Cyoa18BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa18BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa18BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa18BookLoadController(sectionHandler).getClass();
        // THEN
    }
