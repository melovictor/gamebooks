...
/**
 * Unit test for class {@link Cyoa13BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa13BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa13BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa13BookLoadController(sectionHandler).getClass();
        // THEN
    }
