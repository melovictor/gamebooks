...
/**
 * Unit test for class {@link Cyoa17BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa17BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa17BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa17BookLoadController(sectionHandler).getClass();
        // THEN
    }
