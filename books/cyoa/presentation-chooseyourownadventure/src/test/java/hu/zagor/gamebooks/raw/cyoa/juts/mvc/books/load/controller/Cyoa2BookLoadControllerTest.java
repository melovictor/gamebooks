...
/**
 * Unit test for class {@link Cyoa2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa2BookLoadController(sectionHandler).getClass();
        // THEN
    }
