...
/**
 * Unit test for class {@link Cyoa45BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa45BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa45BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa45BookLoadController(sectionHandler).getClass();
        // THEN
    }
