...
/**
 * Unit test for class {@link Cyoa6BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa6BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa6BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa6BookSectionController(sectionHandler).getClass();
        // THEN
    }
