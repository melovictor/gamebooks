...
/**
 * Unit test for class {@link Cyoa19BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa19BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa19BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa19BookLoadController(sectionHandler).getClass();
        // THEN
    }
