package hu.zagor.gamebooks.raw.cyoa.e.mvc.books.load.controller;
...
/**
 * Unit test for class {@link Cyoa20BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cyoa20BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa20BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cyoa20BookLoadController(sectionHandler).getClass();
        // THEN
    }
