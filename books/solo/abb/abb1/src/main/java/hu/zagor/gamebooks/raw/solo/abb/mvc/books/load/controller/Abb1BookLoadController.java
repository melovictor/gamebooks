package hu.zagor.gamebooks.raw.solo.abb.mvc.books.load.controller;
...
public class Abb1BookLoadController extends RawBookLoadController {
     ...
     */
    @Autowired
    public Abb1BookLoadController(@Qualifier("rawSectionHandlingService") final SectionHandlingService sectionHandlingService) {
