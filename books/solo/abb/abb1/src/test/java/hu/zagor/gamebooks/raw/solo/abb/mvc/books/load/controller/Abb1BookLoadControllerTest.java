...
/**
 * Unit test for class {@link Abb1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Abb1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Abb1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Abb1BookLoadController(sectionHandler).getClass();
        // THEN
    }
