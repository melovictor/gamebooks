package hu.zagor.gamebooks.raw.solo.cl.mvc.books.load.controller;
...
public class Cl1BookLoadController extends RawBookLoadController {
     ...
     */
    @Autowired
    public Cl1BookLoadController(@Qualifier("rawSectionHandlingService") final SectionHandlingService sectionHandlingService) {
