...
public class Cl1BookSectionController extends RawBookSectionController {
     ...
     */
    @Autowired
    public Cl1BookSectionController(@Qualifier("rawSectionHandlingService") final SectionHandlingService sectionHandlingService) {
