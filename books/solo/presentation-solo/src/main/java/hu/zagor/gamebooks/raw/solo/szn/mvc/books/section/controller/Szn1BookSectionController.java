...
public class Szn1BookSectionController extends RawBookSectionController {
     ...
     */
    @Autowired
    public Szn1BookSectionController(@Qualifier("rawSectionHandlingService") final SectionHandlingService sectionHandlingService) {
