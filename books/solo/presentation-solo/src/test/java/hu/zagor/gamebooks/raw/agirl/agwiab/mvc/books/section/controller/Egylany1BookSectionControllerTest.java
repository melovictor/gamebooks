...
/**
 * Unit test for class {@link Egylany1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Egylany1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Egylany1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Egylany1BookSectionController(sectionHandler).getClass();
        // THEN
    }
