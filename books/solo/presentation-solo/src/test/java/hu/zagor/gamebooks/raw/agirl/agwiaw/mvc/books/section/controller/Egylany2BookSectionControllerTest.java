...
/**
 * Unit test for class {@link Egylany2BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Egylany2BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Egylany2BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Egylany2BookSectionController(sectionHandler).getClass();
        // THEN
    }
