...
/**
 * Unit test for class {@link Cl1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Cl1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Cl1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Cl1BookLoadController(sectionHandler).getClass();
        // THEN
    }
