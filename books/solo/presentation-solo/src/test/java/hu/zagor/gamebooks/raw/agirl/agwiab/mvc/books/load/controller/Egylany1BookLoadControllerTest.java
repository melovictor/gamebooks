...
/**
 * Unit test for class {@link Egylany1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Egylany1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Egylany1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Egylany1BookLoadController(sectionHandler).getClass();
        // THEN
    }
