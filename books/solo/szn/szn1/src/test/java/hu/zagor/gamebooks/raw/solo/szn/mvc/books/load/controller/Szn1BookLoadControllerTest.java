...
/**
 * Unit test for class {@link Szn1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Szn1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Szn1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Szn1BookLoadController(sectionHandler).getClass();
        // THEN
    }
