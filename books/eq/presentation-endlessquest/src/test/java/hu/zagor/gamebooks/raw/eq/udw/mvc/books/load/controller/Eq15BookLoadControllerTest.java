...
/**
 * Unit test for class {@link Eq15BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Eq15BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Eq15BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Eq15BookLoadController(sectionHandler).getClass();
        // THEN
    }
