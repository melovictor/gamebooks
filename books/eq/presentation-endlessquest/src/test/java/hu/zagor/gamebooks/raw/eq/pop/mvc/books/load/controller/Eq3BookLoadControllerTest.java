package hu.zagor.gamebooks.raw.eq.pop.mvc.books.load.controller;
...
/**
 * Unit test for class {@link Eq3BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Eq3BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Eq3BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Eq3BookLoadController(sectionHandler).getClass();
        // THEN
    }
