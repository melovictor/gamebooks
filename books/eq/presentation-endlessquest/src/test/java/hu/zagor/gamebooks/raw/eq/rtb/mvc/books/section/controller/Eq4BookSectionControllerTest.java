...
/**
 * Unit test for class {@link Eq4BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Eq4BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Eq4BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Eq4BookSectionController(sectionHandler).getClass();
        // THEN
    }
