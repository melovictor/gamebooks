...
/**
 * Unit test for class {@link Eq1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Eq1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Eq1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Eq1BookSectionController(sectionHandler).getClass();
        // THEN
    }
