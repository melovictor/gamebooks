...
/**
 * Unit test for class {@link Eq2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Eq2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Eq2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Eq2BookLoadController(sectionHandler).getClass();
        // THEN
    }
