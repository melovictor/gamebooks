...
/**
 * Unit test for class {@link Eq4BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Eq4BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Eq4BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Eq4BookLoadController(sectionHandler).getClass();
        // THEN
    }
