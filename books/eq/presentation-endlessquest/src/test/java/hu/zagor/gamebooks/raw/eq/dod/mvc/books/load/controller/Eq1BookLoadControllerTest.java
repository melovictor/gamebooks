...
/**
 * Unit test for class {@link Eq1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Eq1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Eq1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Eq1BookLoadController(sectionHandler).getClass();
        // THEN
    }
