...
/**
 * Unit test for class {@link Eq25BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Eq25BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Eq25BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Eq25BookLoadController(sectionHandler).getClass();
        // THEN
    }
