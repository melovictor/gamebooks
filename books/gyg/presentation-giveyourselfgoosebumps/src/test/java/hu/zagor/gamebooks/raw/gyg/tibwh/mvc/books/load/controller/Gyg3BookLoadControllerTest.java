package hu.zagor.gamebooks.raw.gyg.tibwh.mvc.books.load.controller;
...
/**
 * Unit test for class {@link Gyg3BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Gyg3BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Gyg3BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Gyg3BookLoadController(sectionHandler).getClass();
        // THEN
    }
