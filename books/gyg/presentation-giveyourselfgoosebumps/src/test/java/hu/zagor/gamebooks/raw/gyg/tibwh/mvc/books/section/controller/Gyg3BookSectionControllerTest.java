...
/**
 * Unit test for class {@link Gyg3BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Gyg3BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Gyg3BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Gyg3BookSectionController(sectionHandler).getClass();
        // THEN
    }
