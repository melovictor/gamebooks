...
/**
 * Unit test for class {@link Gyg2BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Gyg2BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Gyg2BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Gyg2BookLoadController(sectionHandler).getClass();
        // THEN
    }
