...
/**
 * Unit test for class {@link Gyg1BookSectionController}.
 * @author Tamas_Szekeres
 */
@Test
public class Gyg1BookSectionControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Gyg1BookSectionController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Gyg1BookSectionController(sectionHandler).getClass();
        // THEN
    }
