...
/**
 * Unit test for class {@link Gyg8BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Gyg8BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Gyg8BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Gyg8BookLoadController(sectionHandler).getClass();
        // THEN
    }
