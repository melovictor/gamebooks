...
/**
 * Unit test for class {@link Gyg1BookLoadController}.
 * @author Tamas_Szekeres
 */
@Test
public class Gyg1BookLoadControllerTest {
    ...
    public void testConstructorWhenSectionHandlerIsNullShouldThrowException() {
        ...
        mockControl.replay();
        // WHEN
        new Gyg1BookLoadController(null).getClass();
    ...
    public void testConstructorWhenSectionHandlerProvidedShouldCreateObject() {
        ...
        mockControl.replay();
        // WHEN
        new Gyg1BookLoadController(sectionHandler).getClass();
        // THEN
    }
