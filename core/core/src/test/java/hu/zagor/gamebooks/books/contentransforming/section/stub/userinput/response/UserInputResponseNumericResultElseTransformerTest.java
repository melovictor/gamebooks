...
/**
 * Unit test for class {@link UserInputResponseNumericResultElseTransformer}.
 * @author Tamas_Szekeres
 */
@Test
public class UserInputResponseNumericResultElseTransformerTest extends AbstractTransformerTest {

    private UserInputResponseNumericResultElseTransformer underTest;
    ...
    public void setUpClass() {
        ...
        underTest = new UserInputResponseNumericResultElseTransformer();
    ...
    public void testTransformShouldParseTextAndCreateResponseIntoParent() {
        // GIVEN
        expect(beanFactory.getBean(UserInputNumericResponse.class)).andReturn(response);
