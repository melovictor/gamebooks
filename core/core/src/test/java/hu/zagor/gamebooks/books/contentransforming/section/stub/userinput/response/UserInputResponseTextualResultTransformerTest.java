...
/**
 * Unit test for class {@link UserInputResponseTextualResultTransformer}.
 * @author Tamas_Szekeres
 */
@Test
public class UserInputResponseTextualResultTransformerTest extends AbstractTransformerTest {

    private static final String TEXT = "text";
    private UserInputResponseTextualResultTransformer underTest;
    ...
    public void setUpClass() {
        ...
        underTest = new UserInputResponseTextualResultTransformer();
    ...
    public void testTransformShouldParseTextAndCreateResponseIntoParent() {
        // GIVEN
        expectAttribute("text", TEXT);
        expect(beanFactory.getBean("userInputTextualResponse", TEXT)).andReturn(response);
