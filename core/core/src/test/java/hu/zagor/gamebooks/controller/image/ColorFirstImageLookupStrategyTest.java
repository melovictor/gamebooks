...
/**
 * Unit test for class {@link ColorFirstImageLookupStrategy}.
 * @author Tamas_Szekeres
 */
@Test
public class ColorFirstImageLookupStrategyTest {
    ...
    private ColorFirstImageLookupStrategy underTest;
    ...
    public void setUpMethod() {
        underTest = new ColorFirstImageLookupStrategy();
