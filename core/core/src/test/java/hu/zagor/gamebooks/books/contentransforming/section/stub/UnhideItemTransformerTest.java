 ...
 */
@Test
public class UnhideItemTransformerTest extends AbstractTransformerTest {

    private UnhideItemTransformer underTest;
    ...
    public void setUpClass() {
        ...
        underTest = new UnhideItemTransformer();
        init(mockControl);
