...
public final class Series {
    ...
    public static final long CHOOSE_YOUR_OWN_NIGHTMARE = BASE + 281 * SERIES_MULTIPLIER;

    public static final long ENDLESS_QUEST = BASE + 112 * SERIES_MULTIPLIER;
    public static final long ENDLESS_QUEST_BOOKS_CRIMSON_CRYSTAL_ADVENTURES = BASE + 954 * SERIES_MULTIPLIER;
    ...
    public static final long FIND_YOUR_FATE = BASE + 980 * SERIES_MULTIPLIER;
    public static final long FIND_YOUR_FATE_JEM = BASE + 920 * SERIES_MULTIPLIER;
    public static final long FIND_YOUR_FATE_THE_TRANSFORMERS = BASE + 859 * SERIES_MULTIPLIER;
    ...
    public static final long WHICH_WAY_BOOKS = BASE + 746 * SERIES_MULTIPLIER;
    public static final long WHICH_WAY_SECRET_DOOR_BOOKS = BASE + 391 * SERIES_MULTIPLIER;
