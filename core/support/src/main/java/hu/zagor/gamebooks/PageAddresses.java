package hu.zagor.gamebooks;

/**
 * Utility class containing constants about the names of pages for the controllers to use instead of strings.
...
public final class PageAddresses {
    ...
    public static final String SAVED_GAMES = "savegame";
    ...
    public static final String BOOK_REPLACE_ITEM = "replace";
    public static final String BOOK_CHANGE_ITEM_EQUIP_STATE = "changeEquipState";
