 ...
 */
public class ChangeItemCommandResolver extends AbstractChangeItemCommandResolver<LwCharacter, LwCharacterItemHandler, LwItem> {
    ...
    List<Item> getItemsToChange(final ChangeItemCommand command, final LwCharacter character, final LwCharacterItemHandler itemHandler) {
        ...
        return itemHandler.getItems(character, command.getId());
    }
