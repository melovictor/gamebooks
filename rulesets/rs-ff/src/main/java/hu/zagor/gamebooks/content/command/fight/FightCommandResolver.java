 ...
 */
public class FightCommandResolver extends TypeAwareCommandResolver<FightCommand> {

    private Map<String, FightCommandSubResolver> subResolvers;

    @Override
    protected CommandResolveResult doResolveWithResolver(final FightCommand command, final ResolvationData resolvationData) {
    ...
    private void handleForceWeaponReplacement(final FightCommand command, final FfCharacter character, final FfCharacterItemHandler itemHandler) {
