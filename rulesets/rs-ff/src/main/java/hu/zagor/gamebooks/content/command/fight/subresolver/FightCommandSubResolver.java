...
/**
 * Interface for different resolvation logics for the {@link FfFightCommand} bean.
...
public interface FightCommandSubResolver {
    ...
    /**
     * Do the resolving.
     * @param command the {@link FfFightCommand} to be resolved
     ...
     */
    List<ParagraphData> doResolve(FfFightCommand command, ResolvationData resolvationData);
