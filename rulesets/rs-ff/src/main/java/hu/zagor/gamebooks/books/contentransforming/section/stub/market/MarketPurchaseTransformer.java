...
/**
 * Sub transformer for transforming "purchase" elements in "market".
 * @author Tamas_Szekeres
 */
public class MarketPurchaseTransformer extends AbstractCommandSubTransformer<MarketCommand> {
    ...
    protected void doTransform(final BookParagraphDataTransformer parent, final Node node, final MarketCommand command, final ChoicePositionCounter positionCounter) {
        ...
        command.getItemsForPurchase().add(element);
    }
