...
public class FightCommandBasicSubResolverWithOnlyHighestLinkedFightRoundResolverIT extends FfItTextResolvingTest {
    ...
    public void testDoResolveWhenInSingleBattleThereAreTwoEnemiesAndWeTieShouldNobodyLoseHealth() {
        ...
        expect(generator.getRandomNumber(2, 0)).andReturn(new int[]{7, 4, 3});
        expect(generator.getRandomNumber(2)).andReturn(new int[]{7, 1, 6});
        expect(generator.getRandomNumber(2)).andReturn(new int[]{7, 2, 5});
        expectText("page.ff.label.fight.single.attackStrength.self", new Object[]{4, 3, 15});
        logger.debug("Attack strength for self: {}", 15);
        expectText("page.ff.label.fight.single.attackStrength.enemy", new Object[]{"Two-Headed Dog, First Head", 1, 6, 15});
        logger.debug("Attack strength for {}: {}", "Two-Headed Dog, First Head", 15);
        expectText("page.ff.label.fight.single.attackStrength.enemy", new Object[]{"Two-Headed Dog, Second Head", 2, 5, 15});
    ...
    public void testDoResolveWhenInSingleBattleThereAreTwoEnemiesAndOneLosesTheOtherTiesShouldNobodyLoseHealth() {
        ...
        expect(beanFactory.getBean("singleFightRoundResolver", FightRoundResolver.class)).andReturn(fightRoundResolver);
        expect(generator.getRandomNumber(2, 0)).andReturn(new int[]{7, 4, 3});
        expect(generator.getRandomNumber(2)).andReturn(new int[]{6, 1, 5});
        expect(generator.getRandomNumber(2)).andReturn(new int[]{7, 2, 5});
        expectText("page.ff.label.fight.single.attackStrength.self", new Object[]{4, 3, 15});
        logger.debug("Attack strength for self: {}", 15);
        expectText("page.ff.label.fight.single.attackStrength.enemy", new Object[]{"Two-Headed Dog, First Head", 1, 5, 14});
    ...
    public void testDoResolveWhenInSingleBattleThereAreTwoEnemiesAndOneTiesTheOtherLosesShouldNobodyLoseHealth() {
        ...
        expectText("page.ff.label.fight.single.attackStrength.enemy", new Object[]{"Two-Headed Dog, First Head", 1, 6, 15});
        logger.debug("Attack strength for {}: {}", "Two-Headed Dog, First Head", 15);
        expectText("page.ff.label.fight.single.attackStrength.enemy", new Object[]{"Two-Headed Dog, Second Head", 1, 5, 14});
    ...
    public void testDoResolveWhenInSingleBattleThereAreTwoEnemiesAndBothLosesShouldBothLoseHealth() {
        ...
        expect(beanFactory.getBean("singleFightRoundResolver", FightRoundResolver.class)).andReturn(fightRoundResolver);
        expect(generator.getRandomNumber(2, 0)).andReturn(new int[]{7, 4, 3});
        expect(generator.getRandomNumber(2)).andReturn(new int[]{5, 1, 4});
        expect(generator.getRandomNumber(2)).andReturn(new int[]{6, 1, 5});
        expectText("page.ff.label.fight.single.attackStrength.self", new Object[]{4, 3, 15});
        logger.debug("Attack strength for self: {}", 15);
        expectText("page.ff.label.fight.single.attackStrength.enemy", new Object[]{"Two-Headed Dog, First Head", 1, 4, 13});
    ...
    public void testDoResolveWhenInSingleBattleThereAreTwoEnemiesAndOneLosesOneWinsShouldHeroLoseHealth() {
        ...
        expect(beanFactory.getBean("singleFightRoundResolver", FightRoundResolver.class)).andReturn(fightRoundResolver);
        expect(generator.getRandomNumber(2, 0)).andReturn(new int[]{7, 4, 3});
        expect(generator.getRandomNumber(2)).andReturn(new int[]{8, 4, 4});
        expect(generator.getRandomNumber(2)).andReturn(new int[]{6, 1, 5});
        expectText("page.ff.label.fight.single.attackStrength.self", new Object[]{4, 3, 15});
        logger.debug("Attack strength for self: {}", 15);
        expectText("page.ff.label.fight.single.attackStrength.enemy", new Object[]{"Two-Headed Dog, First Head", 4, 4, 16});
    ...
    public void testDoResolveWhenInSingleBattleThereAreTwoEnemiesAndBothWinsShouldHeroLoseHealthOnlyOnce() {
        ...
        getMessageList().switchToRoundMessages();
        expect(beanFactory.getBean("singleFightRoundResolver", FightRoundResolver.class)).andReturn(fightRoundResolver);
        expect(generator.getRandomNumber(2, 0)).andReturn(new int[]{5, 4, 1});
        expect(generator.getRandomNumber(2)).andReturn(new int[]{8, 4, 4});
        expect(generator.getRandomNumber(2)).andReturn(new int[]{6, 1, 5});
        expectText("page.ff.label.fight.single.attackStrength.self", new Object[]{4, 1, 13});
