...
/**
 * Unit test for class {@link FfFightCommand}.
 * @author Tamas_Szekeres
 */
@Test
public class FfFightCommandTest extends AbstractCommandTest {

    private FfFightCommand underTest;
    ...
    public void testCloneWhenAllComplexFieldsAreSetShouldReturnClone() throws CloneNotSupportedException {
        ...
        mockControl.replay();
        // WHEN
        final FfFightCommand returned = underTest.clone();
        // THEN
